...
export class SelectionHelper {
  ...
  public selectedPostIt: KanbanDocumentModel;

  constructor(private postIts: KanbanDocumentModel[],
  ...
  private firstPostIt(): KanbanDocumentModel {
  ...
  public selectNext(postIt: KanbanDocumentModel): void {
  ...
  public select(column: number, row: number, postIt: KanbanDocumentModel): void {
    this.selectedPostIt = postIt;
